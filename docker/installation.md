...
Create folder and change directory for docker install Script

```
mkdir docker && cd /docker
```

Create docker install script file

```
nano docker-install.sh
```

Visit [docker-install.sh](https://github.com/lazy-media/public/blob/main/Docker/Installation/docker-install.sh) or copy the following into the docker-install.sh file
