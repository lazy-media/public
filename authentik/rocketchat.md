...
* Basic understanding of setting up an Authentik OAuth2/OpenID Provider and Application, if not, you can follow this guide [Basic OAuth/OpenID Setup](applications-and-providers.md#authentik-basic-oauth2openid-setup)
