...
{% hint style="warning" %}
YOUR RESULTS MAY VARY! CLOUDFLARE ZERO TRUST IS NOT ACTIVELY USED IN THIS DOCUMENTATION. IT WAS ONLY SET UP AS A QUICK TEST TO HELP WITH A SUPPORT QUESTION.
{% endhint %}

{% hint style="warning" %}
THIS WAS ABLE TO GET A LOGIN TO A CLOUDFLARE ZERO TRUST INSTANCE AND ABLE TO VIEW APPLICATIONS AFTER THE APPROPRIATE PERMISSIONS WERE IN PLACE IN CLOUDFLARE. THIS IS GOING TO BE YOUR RESPONSIBILITY TO FIGURE OUT.
{% endhint %}
