---
description: Information on how to setup Vikunja OpenID / OAuth with Authentik
---
...
* [Vikunja OAuth Documentation](https://vikunja.io/docs/openid-example-configurations/#authentik)
* [Authentik OAuth Setup](https://docs.goauthentik.io/integrations/services/vikunja/)

## Assumptions

* Basic understanding of setting up Authentik OAuth2/OpenID Provider & Application, if not, you can follow this guide [Basic OAuth/OpenID Setup](applications-and-providers.md#authentik-basic-oauth2openid-setup)
...
service:
  ...
  JWTSecret: "SOME-RANDOM-PASSWORD"
  ...
  publicurl: "https://vikunja.domain.example"
  # frontend_url: "https://vikunja.domain.example"
  # api_url: "https://vikunja.domain.example"
  # The base path on the file system where the binary and assets are.
  # Vikunja will also look in this path for a config file, so you could provide only this variable to point to a folder
  # with a config file which will then be used.
  rootpath: /var/lib/docker/volumes/vikunja-data/_data
...
sentry:
  ...
  dsn: "SHOULD BE AN AUTO-CREATED URL"
  ...
  frontenddsn: "SHOULD BE AN AUTO-CREATED URL"
...
files:
  ...
  basepath: /var/lib/docker/volumes/vikunja-data/_data/files # relative to the binary
...
migration:
  todoist:
    ...
    redirecturl: https://vikunja.domain.example/migrate/todoist
  trello:
    ...
    redirecturl: https://vikunja.domain.example/migrate/trello
  microsofttodo:
    ...
    redirecturl: https://vikunja.domain.example/migrate/microsoft-todo
...
auth:
  ...
  openid:
    ...
    enabled: true
    # Redirect URL for Vikunja
    redirecturl: https://vikunja.domain.example/auth/openid/VIKUNJA-OAUTH-NAME
    # A list of enabled providers
    providers:
      # The name of the provider as it will appear in the frontend.
      - name: "Authentik"
        # The auth url to send users to if they want to authenticate using OpenID Connect.
        authurl: https://auth.domain.example/application/o/AUTHENTIK-OAUTH-SLUG/
        # The logout url to send users upon logging out of Vikunja
        logouturl: https://auth.domain.example/application/o/AUTHENTIK-OAUTH-SLUG/end-session/
        # The client ID used to authenticate Vikunja at the OpenID Connect provider.
        clientid: AUTHENTIK-OAUTH-CLIENT-ID
        # The client secret used to authenticate Vikunja at the OpenID Connect provider.
        clientsecret: AUTHENTIK-OAUTH-CLIENT-SECRET
        # Scopes to use
        scope: openid profile email ak_proxy offline_access
        

# Prometheus metrics endpoint
######################################################
########### EXAMPLED PROMETHEUS JOB ##################
######################################################
##### - job_name: "Vikunja"                      #####
#####   static_configs:                          #####
#####     - targets: ["vikunja.ip.address:port"] #####
