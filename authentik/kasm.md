---
description: Information on how to setup Kasm OpenID / OAuth with Authentik
---
...
* _You don't need all your Authentik Groups in Kasm, just the ones you want, like the group you have set in Authentik to access Kasm._
...
* Fill out the form as follows:
  ...
  * **Scope** _(NEW LINE FOR EACH)_ = `email` `profile` `openid` `ak_proxy`
