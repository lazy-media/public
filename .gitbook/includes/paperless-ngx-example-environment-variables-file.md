---
title: Paperless-NGX Example Environment Variables File
---

{% code expandable="true" %}
```dotenv
###############################################################################################
##### This lists all of the Environment Variables listed on Paperless NGX Website         #####
##### Please refer to the Paperless NGX Webiste for Proper Configuration of each Variable #####
##### Paperless Website = https://docs.paperless-ngx.com                                  #####
##### Uncomment any line you need active                                                  #####
###############################################################################################
...
### Tika and Gotenberg Configuration
# PAPERLESS_TIKA_ENABLED=
# PAPERLESS_TIKA_ENDPOINT=
# PAPERLESS_TIKA_GOTENBERG_ENDPOINT=

### Paths and Folders Configuration
...
### Collate Double-Sided Documents Configuration
